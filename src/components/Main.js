...
import johnAvatar from "../assets/john.jpeg"
import {
    Loader, Navbar, SideAnchorLinks, Hero, About, Experience, Projects, Hobbies, Footer,
} from "../components";
import Tech from "./sections/Tech";

const StyledMainPage = styled("div")(({theme}) => ({
    backgroundColor: theme.palette.background.main, overflow: "hidden",
}));
